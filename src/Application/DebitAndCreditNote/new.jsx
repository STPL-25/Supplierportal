...
function ImageCard() {
  ...
  const fetchInvDetails = async () => {
    ...
    try {
      const payload = {
        selectedSupplier: userRole.includes("Supplier") ? companyName : selectedSupplier, // Correct payload structure
      };
  ...
  const fetchImagesData = async () => {
    ...
    try {
      ...
      const { supCredit, supDebit, KTMDebitAcceptImg, KTMDebitRejectImg, KTMCreditAcceptImg, KTMCreditRejectImg, id } = response.data;
                      ...
                      .map((img, index) => (
                        ...
                        >
                          ...
                          <div className="flex justify-center space-x-4 p-4 bg-gray-50">
                            <button 
                              type="button"
                              onClick={() => handleAccept(img, noteType)}
                            ...
                            <button 
                              type="button"
                              onClick={() => handleReject(img, noteType)}
